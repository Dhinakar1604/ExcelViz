...
const SavedAnalyses = () => {
   ...
   <div className="logo-title saved-analyses-title">📊 Saved Analyses</div>
                ...
                {selectedAnalysis && (
                    ...
                    >
                        <div style={{ background: "#1e293b", padding: "20px", borderRadius: "8px", maxWidth: "90%", maxHeight: "90%" }}>
                            <h2>{selectedAnalysis.chartTitle}</h2>
                            <canvas ref={chartRef} style={{ maxWidth: "100%", maxHeight: "60vh" }}></canvas>
                            <div style={{ marginTop: "10px", display: "flex", justifyContent: "center" }}>
                                <button onClick={handleDownloadPNG} style={{ marginRight: "10px" }}>Download PNG</button>
                ...
                {deleteId && (
                    ...
                    >
                        ...
                        >
                            <h3>Are you sure you want to delete this analysis?</h3>
                            <p>This action cannot be undone.</p>
                            <div style={{ marginTop: "10px", display: "flex", justifyContent: "center" }}>
                                <button
                                    onClick={() => handleDelete(deleteId)}
                                    style={{ marginRight: "10px", background: "darkred", color: "#fff", padding: "6px 12px", borderRadius: "4px" }}
                                >
                                    Yes, Delete
                                </button>
                                <button
